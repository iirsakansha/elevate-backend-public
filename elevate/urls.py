...
urlpatterns = [
    ...
    path('api/password-reset-request/',
         views.PasswordResetRequestAPI.as_view(), name='password-reset-request'),
    ...
    path('api/invitation/<str:token>/',
         views.GetInvitationDetailsAPI.as_view(), name='get-invitation-details'),
    path('api/invited-users/all/', views.ListInvitedUsersAPI.as_view(),
         name='list-invited-users'),
    path('api/delete-user/<int:id>/',
         views.DeleteInvitedUserAPI.as_view(), name='delete-invited-user'),
